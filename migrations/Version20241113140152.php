 ...
 */
final class Version20241113140152 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projet_personne (projet_id INT NOT NULL, personne_id INT NOT NULL, INDEX IDX_284EA218A21BD112 (personne_id), INDEX IDX_284EA218C18272 (projet_id), PRIMARY KEY(projet_id, personne_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
